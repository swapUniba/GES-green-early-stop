...
def process(dataset, model,max_emission_step, ratio_tolerance):
	...
	# run_recbole is edited - see the recbole_edit folder for the new implementation
	run_recbole(
...
if __name__ == "__main__":
	...
	if 'DATASET' in keys and 'MODEL' in keys:
		...
		# get other parameters (model, data, GES parameters)
